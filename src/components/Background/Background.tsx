      ...
      <div className="shape-wrap">
        <svg ref={shape1} className="shape" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
          <path
            ...
            fill="#0099ff"
            fillOpacity="0.65"
            d="M0,256L60,256C120,256,240,256,360,229.3C480,203,600,149,720,138.7C840,128,960,160,1080,165.3C1200,171,1320,149,1380,138.7L1440,128L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"
            data-alt-d="M0,128L60,133.3C120,139,240,149,360,133.3C480,117,600,75,720,80C840,85,960,139,1080,144C1200,149,1320,107,1380,85.3L1440,64L1440,320L1380,320C1320,320,1200,320,1080,320C960,320,840,320,720,320C600,320,480,320,360,320C240,320,120,320,60,320L0,320Z"
          ></path>
        </svg>
